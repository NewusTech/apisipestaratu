        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a href="<?php echo site_url('subjek_tipe/create_subjek_tipe') ?>" class="btn btn-primary" type="button"><?php echo lang('button_label_add_subjek_tipe');?></a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered" id="datatable">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th><?php echo lang('view_subjek_tipe_th');?></th>
