        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a href="<?php echo site_url('profil_item/create_profil_item') ?>" class="btn btn-primary" type="button"><?php echo lang('button_label_add_profil_item');?></a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered" id="datatable">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th><?php echo lang('view_profil_item_th');?></th>
